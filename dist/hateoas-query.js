    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            case 0:
                ...
                return [
                    4,
                    queryIsolated(node, selector, options, results)
                ];
            case 1:
                return [
                    2,
...
function queryIsolated(node, selector, options, results) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var only, links, path, isIterable, isAction, remainingSelector, requestOptions, actionParams, item, response_1, error, response, items, filteredItems, responses;
        return __generator(this, function (_a) {
            ...
            case 0:
                ...
                if (!selector) {
                    ...
                    if (!only) {
                        ...
                        return [
                            2,
                            _.pick(extended(node), only)
                        ];
                    } else {
                        return [
                            2,
                            _.pickBy(extended(node), only)
                        ];
                    }
                }
                links = selector.split('.');
                path = links.shift();
                isIterable = isSelectorIterable(path);
                isAction = isSelectorAnAction(path);
                remainingSelector = links.join('.');
                if (isAction) {
            ...
            case 1:
                ...
                return [
                    2,
                    extended(_.extend(response_1, { _origin: node }))
                ];
            case 2:
                error = 'Could not traverse `' + selector + '`';
            ...
            case 3:
                return [
                    4,
                    options.request(_.extend({}, requestOptions, { params: actionParams }))
                ];
            case 4:
                response = _a.sent();
                ...
                return [
                    4,
                    queryIsolated(response, remainingSelector, options, results)
                ];
            case 5:
                response = _a.sent();
                return [
            ...
            case 6:
                ...
                filteredItems = isSelectorFiltered(path) ? items[getSelectorFilter(path)] : items;
                return [
                    4,
                    Promise.all(filteredItems.map(function (item) {
...
function extended(obj) {
    ...
    obj.query = function () {
        ...
        return query.apply(void 0, [obj].concat(args));
    };
    obj.queryIsolated = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        return queryIsolated.apply(void 0, [obj].concat(args));
    };
    if (!isArray) {
        obj.get = function () {
            var args = [];
            ...
            return extended(_.get.apply(_, [obj].concat(args)));
        };
        obj.has = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return extended(_.has.apply(_, [obj].concat(args)));
        };
        obj.keys = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return extended(_.keys.apply(_, [obj].concat(args)));
        };
        obj.values = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return extended(_.values.apply(_, [obj].concat(args)));
        };
    }
    if (isArray) {
        obj.find = function () {
            ...
            return extended(_.find.apply(_, [obj].concat(args)));
        };
        obj.map = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return extended(_.map.apply(_, [obj].concat(args)));
        };
        obj.filter = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return extended(_.filter.apply(_, [obj].concat(args)));
        };
        obj.reduce = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return extended(_.reduce.apply(_, [obj].concat(args)));
        };
    }
    return obj;
}
var getLink = function (node, path) {
    return _.get(node, '_links.' + path.replace(/\[\d*]$/, '') + '.href');
};
var getAction = function (node, path) {
    return _.get(node, '_actions.' + path.replace(/^@/, ''), {});
};
var getAttribute = function (node, path) {
    return _.get(node, path);
};
var isSelectorIterable = function (selector) {
    return /\[\d*]$/.test(selector);
};
var isSelectorFiltered = function (selector) {
    return /\[\d+]$/.test(selector);
};
var isSelectorAnAction = function (selector) {
    return /^@/.test(selector);
};
var getSelectorFilter = function (selector) {
    var n = selector.match(/\[(\d*)]/)[1];
...
var instance = function (_a) {
    var request = _a.request, strict = _a.strict;
    return query.bind({
        request: request,
        strict: strict
    });
};
instance.query = function (_a) {
    var request = _a.request, strict = _a.strict;
    return query.bind({
        request: request,
        strict: strict
...
instance.isolated = function (_a) {
    var request = _a.request, strict = _a.strict;
    return queryIsolated.bind({
        request: request,
        strict: strict
    });
};
...
(function () {
    ...
    var freeGlobal = 'undefined' == 'object' && global && global.Object === Object && global;
    ...
    var _ = runInContext();
    if ('undefined' == 'function' && typeof define.amd == 'object' && define.amd) {
        root._ = _;
        define(function () {
            return _;
        });
